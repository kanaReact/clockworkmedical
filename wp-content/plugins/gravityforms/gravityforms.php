...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    ...
    // Intercept version.php requests to add Turnstile to offerings
    else if (strpos($url, 'https://gravityapi.com/wp-content/plugins/gravitymanager/version.php') !== false) {
        return [
            'headers' => [],
            'body' => json_encode([
                "version" => "2.8.7",
                ...
                "offerings" => [
                    // Payment Gateways
                    "gravityformsstripe" => ["is_available" => true],
                    "gravityformspaypal" => ["is_available" => true],
                    "gravityformspaypalpaymentspro" => ["is_available" => true],
                    "gravityformspaypalpro" => ["is_available" => true],
                    "gravityformspaypalcommerce" => ["is_available" => true],
                    "gravityformsauthorizenet" => ["is_available" => true],
                    "gravityformssquare" => ["is_available" => true],
                    "gravityformsmollie" => ["is_available" => true],
                    "gravityforms2checkout" => ["is_available" => true],
                    
                    // Email Marketing
                    "gravityformsmailchimp" => ["is_available" => true],
                    "gravityformsactivecampaign" => ["is_available" => true],
                    "gravityformsaweber" => ["is_available" => true],
                    "gravityformscampaignmonitor" => ["is_available" => true],
                    "gravityformsgetresponse" => ["is_available" => true],
                    "gravityformsconstantcontact" => ["is_available" => true],
                    "gravityformsemma" => ["is_available" => true],
                    "gravityformsicontact" => ["is_available" => true],
                    "gravityformsmadmimi" => ["is_available" => true],
                    "gravityformscleverreach" => ["is_available" => true],
                    "gravityformsconvertkit" => ["is_available" => true],
                    "gravityformssendinblue" => ["is_available" => true],
                    "gravityformsactivecampaign" => ["is_available" => true],
                    "gravityformsmailerlite" => ["is_available" => true],
                    
                    // CRM
                    "gravityformssalesforce" => ["is_available" => true],
                    "gravityformshubspot" => ["is_available" => true],
                    "gravityformszohocrm" => ["is_available" => true],
                    "gravityformscapsulecrm" => ["is_available" => true],
                    "gravityformsagilecrm" => ["is_available" => true],
                    "gravityformshighlevel" => ["is_available" => true],
                    "gravityformspipedrive" => ["is_available" => true],
                    "gravityformscrm" => ["is_available" => true],
                    
                    // Productivity & Storage
                    "gravityformsdropbox" => ["is_available" => true],
                    "gravityformsgooglesheets" => ["is_available" => true],
                    "gravityformstrello" => ["is_available" => true],
                    "gravityformsslack" => ["is_available" => true],
                    "gravityformsasana" => ["is_available" => true],
                    "gravityformsnotice" => ["is_available" => true],
                    
                    // Security & Anti-Spam
                    "gravityformsturnstile" => ["is_available" => true],
                    "gravityformsrecaptcha" => ["is_available" => true],
                    "gravityformsakismet" => ["is_available" => true],
                    "gravityformszerobound" => ["is_available" => true],
                    
                    // Form Features
                    "gravityformspolls" => ["is_available" => true],
                    "gravityformsquiz" => ["is_available" => true],
                    "gravityformssurvey" => ["is_available" => true],
                    "gravityformssignature" => ["is_available" => true],
                    "gravityformscoupons" => ["is_available" => true],
                    "gravityformspartialentries" => ["is_available" => true],
                    "gravityformschainedselects" => ["is_available" => true],
                    "gravityformsgeolocation" => ["is_available" => true],
                    "gravityformsadvancedpostcreation" => ["is_available" => true],
                    "gravityformsuserregistration" => ["is_available" => true],
                    "gravityformslimitentries" => ["is_available" => true],
                    "gravityformslistlockdown" => ["is_available" => true],
                    
                    // Automation & Integration
                    "gravityformszapier" => ["is_available" => true],
                    "gravityformswebhooks" => ["is_available" => true],
                    "gravityformsrest" => ["is_available" => true],
                    "gravityformscli" => ["is_available" => true],
                    
                    // Other Integrations
                    "gravityformstwilio" => ["is_available" => true],
                    "gravityformsbreeze" => ["is_available" => true],
                    "gravityformsbatchbook" => ["is_available" => true],
                    "gravityformscampfire" => ["is_available" => true],
                    "gravityformsfreshbooks" => ["is_available" => true],
                    "gravityformshelp-scout" => ["is_available" => true],
                    "gravityformshipchat" => ["is_available" => true],
                    "gravityformspostmark" => ["is_available" => true]
                ]
            ]),
            'response' => [
                'code' => 200,
