...
final class THEMECOMPLETE_EPO_Data_Store_Base {
	...
	public function init() {
		...
		if ( '' !== $this->data_store['tm_epo_global_image_max_width'] || '' !== $this->data_store['tm_epo_global_image_max_height'] ) {
			$image_css = '.woocommerce #content table.cart img.epo-option-image, .woocommerce table.cart img.epo-option-image, .woocommerce-page #content table.cart img.epo-option-image, .woocommerce-page table.cart img.epo-option-image, .woocommerce-mini-cart .cpf-img-on-cart .epo-option-image, .woocommerce-checkout-review-order .cpf-img-on-cart .epo-option-image, .woocommerce-order-details .cpf-img-on-cart .epo-option-image, .epo-option-image, .cpf-img-on-order img, .cpf-img-on-order > * {';
		...
		$this->data_store = apply_filters( 'wc_epo_data_store', $this->data_store, $this );
	}
