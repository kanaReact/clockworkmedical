...
isUpdating=!0;try{let newValue=refresher();if(newValue!==undefined){input.value=newValue}["change","input"].forEach((eventType)=>{let evt;if("createEvent" in document){evt=document.createEvent("HTMLEvents");evt.initEvent(eventType,!0,!0)}else{evt=document.createEvent("Event");evt.initEvent(eventType,!0,!0)}
