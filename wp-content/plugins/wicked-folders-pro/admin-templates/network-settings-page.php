    ...
    <div class="wicked-settings wicked-clearfix">
        ...
        <div class="wicked-right">
            <div class="wicked-logo">
                <a href="https://wickedplugins.com/" target="_blank"><img src="<?php echo plugin_dir_url( dirname( __FILE__ ) ); ?>core/images/wicked-plugins-logo.png" alt="Wicked Plugins" width="300" height="223" /></a>
            </div>
