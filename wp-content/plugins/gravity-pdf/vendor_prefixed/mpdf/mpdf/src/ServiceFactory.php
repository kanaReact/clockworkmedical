...
class ServiceFactory
{
    ...
    public function getServices(\GFPDF_Vendor\Mpdf\Mpdf $mpdf, \GFPDF_Vendor\Psr\Log\LoggerInterface $logger, $config, $languageToFont, $scriptToLanguage, $fontDescriptor, $bmp, $directWrite, $wmf)
    {
        ...
        $cache = new \GFPDF\Helper\Mpdf\Cache($cacheBasePath, $config['cacheCleanupInterval']);
        $fontCache = new \GFPDF_Vendor\Mpdf\Fonts\FontCache(new \GFPDF\Helper\Mpdf\Cache($cacheBasePath . '/ttfontdata', $config['cacheCleanupInterval']));
